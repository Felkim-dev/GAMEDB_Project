...
class Character(db.Model):
    ...
    missions_link = db.relationship("CharacterMission", back_populates="char_mission")
    inventory_holders = db.relationship("Inventory", back_populates="character")
    given_transactions= db.relationship("Transaction", back_populates="giver", foreign_keys='Transaction.GiverID')
    received_transactions= db.relationship("Transaction", back_populates="receiver", foreign_keys='Transaction.ReceiverID')
